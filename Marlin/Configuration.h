...
#define STRING_CONFIG_H_AUTHOR "(wossname, 20240603)" // Who made the changes.
...
// Choose the name from boards.h that matches your setup
  ...
  //#define MOTHERBOARD BOARD_FORMBOT_RAPTOR // wossname - fra TH3D
#endif
...
#define CUSTOM_MACHINE_NAME "Vivedino Raptor 2"
...
#define TEMP_SENSOR_BED 11 // wossname - Keenovo AC bed
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 11.90 //wossname - calibrated with: M303 E0 S200 C8
    #define DEFAULT_Ki 0.67  //wossname - calibrated with fan on 100%
...
#define PIDTEMPBED
  ...
  //wossname - calibrated with: M303 E-1 C8 S60
  #define DEFAULT_bedKp 118.83
  #define DEFAULT_bedKi 23.40
  #define DEFAULT_bedKd 402.37
#else
...
#define X_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. //wossname
#define Y_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. //wossname
...
#define Y_MAX_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. //wossname
#define Z_MAX_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. //wossname
...
#define DEFAULT_AXIS_STEPS_PER_UNIT { 80, 80, 800, 96 } //wossname
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 250, 150, 5, 25 } //wossname
...
//#define CLASSIC_JERK
  ...
  #define DEFAULT_ZJERK  0.4 //wossname
 ...
 */
#define DEFAULT_XJERK 10.0 //wossname
#define DEFAULT_YJERK  5.0 //wossname
...
//#define USE_PROBE_FOR_Z_HOMING //wossname - automatically enabled when BLTouch is activated
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -22, 0, -1.5 } //wossname

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 50 //wossname
 ...
 */
#define MULTIPLE_PROBING 3 //wossname
...
#define Z_AFTER_PROBING           5 // (mm) Z position after probing is done //wossname
...
#define INVERT_X_DIR true //wossname
...
#define INVERT_E0_DIR false //wossname
 ...
 */
//#define Z_IDLE_HEIGHT Z_HOME_POS //wossname
...
#define MAX_SOFTWARE_ENDSTOPS
  ...
  #define SOFT_ENDSTOPS_MENU_ITEM  // Enable/Disable software endstops from the LCD //wossname
#endif
 ...
 */
#define FILAMENT_RUNOUT_SENSOR //wossname
#if ENABLED(FILAMENT_RUNOUT_SENSOR)
  #define FIL_RUNOUT_ENABLED_DEFAULT true // Enable the sensor on startup. Override with M412 followed by M500.
  #define NUM_RUNOUT_SENSORS   1          // Number of sensors, up to one per extruder. Define a FIL_RUNOUT#_PIN for each.
  #define FIL_RUNOUT_PIN 57 //wossname

  #define FIL_RUNOUT_STATE     HIGH        // Pin state indicating that filament is NOT present. //wossname
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 6 //wossname - it is a lot of points, but I only run it once and load mesh using "M420 S1 Z10" in startup G-Code
  ...
  #define PROBE_Y_FIRST
    ...
    #define EXTRAPOLATE_BEYOND_GRID //wossname
  ...
  #define MESH_EDIT_GFX_OVERLAY   // Display a graphics overlay while editing the mesh //wossname
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_USE_PROBE //wossname
...
#define Z_SAFE_HOMING
  ...
  //#define Z_SAFE_HOMING_X_POINT 178  // (mm) X point for Z homing/
  //#define Z_SAFE_HOMING_X_POINT X_CENTER  // (mm) X point for Z homing
  //#define Z_SAFE_HOMING_Y_POINT 200  // (mm) Y point for Z 
  #define Z_SAFE_HOMING_X_POINT ((X_BED_SIZE) / 2)    // X point for Z homing when homing all axes (G28). //wossname
  #define Z_SAFE_HOMING_Y_POINT ((Y_BED_SIZE) / 2)    // Y point for Z homing when homing all axes (G28). //wossname
 ...
 */
//#define SKEW_CORRECTION  //wossname - calibrate and input numbers. rebuild firmware
...
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
  ...
  #define EEPROM_INIT_NOW   // Init EEPROM on first boot after a new build. //wossname
#endif
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU //wossname
#define INDIVIDUAL_AXIS_HOMING_SUBMENU //wossname
