 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 210        // (seconds) //wossname
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD  210               // (seconds) //wossname
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        300 // (seconds) //wossname
...
#define CASE_LIGHT_ENABLE
  ...
  //#define CASE_LIGHT_PIN 4                  // Override the default pin if needed //wossname - ToDo: try this?
  //#define LED_PIN 13                        //default pin for Ramps
...
//
#define ASSISTED_TRAMMING //wossname
#if ENABLED(ASSISTED_TRAMMING)

  // Define from 3 to 9 points to probe.
  #define TRAMMING_POINT_XY { {  60, 60 }, { 340,  60 }, { 340, 340 }, { 60, 340 } } //wossname - should really replaced with Xmax/Ymax values
  ...
  #define ASSISTED_TRAMMING_WIZARD    // Add a Tramming Wizard to the LCD menu //wossname
 ...
 */
//#define INPUT_SHAPING_X //wossname - print the calibration print from TH3D, activate and input values here
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu //wossname
     ...
     */
    //#define PROBE_OFFSET_WIZARD_START_Z 2.0 //wossname
    ...
    //#define PROBE_DEPLOY_STOW_MENU //wossname
  #endif
...
#define SET_PROGRESS_MANUALLY //wossname
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_LIMIT       20     // Maximum number of sorted items (10-256). Costs 27 bytes each. //wossname
  ...
  #define LONG_FILENAME_HOST_SUPPORT    // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L' //wossname
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES         // Scroll long filenames in the SD card menu //wossname
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_ALWAYS_AVAILABLE       // Allow babystepping at all times (not just during movement) //wossname
  ...
  //#define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping //wossname - removed; I want classic babystepping
 ...
 */
  ...
  #define PROBE_PT_1_X 50 //wossname
